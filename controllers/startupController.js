...
// @desc  Create or update startup (alumni)
...
// @desc  Request collaboration (student)
// @route POST /api/startups/:id/collaborate
...
// @desc  Respond to collaboration request (alumni/founder)
// @route PUT /api/startups/:id/collaborate/:reqId
